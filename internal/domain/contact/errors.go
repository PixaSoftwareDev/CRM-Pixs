...
var (
	...
	ErrIndustryNotFound       = errors.New("rubro no encontrado")
	ErrIndustryAlreadyExists  = errors.New("ya existe un rubro con ese nombre")
	ErrIndustryNameRequired   = errors.New("el nombre del rubro no puede estar vacío")
