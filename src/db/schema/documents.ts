 ...
 * la línea de tiempo: cuelga de un proyecto, un cliente o un movimiento de
 * finanzas (comprobante) vía entityType + entityId (sin FK dura). El binario
 * vive en el filesystem (`storage/documents`), acá solo va la metadata.
 * Ver src/lib/storage.ts.
 */
export const DOCUMENT_ENTITIES = ["project", "contact", "transaction"] as const
